...
public class ErrorResponseMappingTest {
    ...
    void beforeEach(WireMockRuntimeInfo wmRuntimeInfo) {
        ...
        this.webClientWithErrorHandler =
                WebClient.builder()
    ...
    void test() {
                                ...
                                ex -> {
                                    if (ex instanceof WebClientResponseException wre) {
                                        var errorResponseBody =
                                                wre.getResponseBodyAs(SampleResponse.class);
        ...
        StepVerifier.create(actual)
                .expectErrorSatisfies(
                        ex -> {
                            ...
                            assertThat(sampleException.getErrorResponseBody())
        ...
        actual = webClientWithErrorHandler.get().uri("/sample").retrieve().bodyToMono(Void.class);
